...
Knowledge Basesのhybrid searchは、storeとregionによって利用条件が変わり得ます。採用時点に[ユーザーガイド](https://docs.aws.amazon.com/bedrock/latest/userguide/kb-test-config.html)、[API Reference](https://docs.aws.amazon.com/bedrock/latest/APIReference/API_KnowledgeBaseVectorSearchConfiguration.html)、リリース情報を同一日に確認し、対象リージョンの最小indexへ`HYBRID`を指定する疎通試験を行います。確認日、region、store種別、index schema、request、responseを証跡へ残します。
