...
RAGとは何か、アーキテクチャ、検索を支える技術要素、評価と改善、機能要件、AWSでRAGを設計する、の6分類・27小節とまとめで構成します。デジタル庁デザインシステムの指針を発表用へ調整した共通の文字・余白で構成し、編集可能な5技術図と、導入・業務例・次の話への接続を含む全30枚の発表者原稿を用意しています。表示仕様は[勉強会の表示設計](handson/aws-rag/docs/SEMINAR_DESIGN.md)に記載しています。
