...
![図: RAGの基本構造](assets/images/01-rag-basic-structure.png)
...
![図: RAGパイプライン全体像](assets/images/02-rag-pipeline-overview.png)
...
![図: Offline / Online RAGアーキテクチャ全体図](assets/images/03-offline-online-rag-architecture.png)
...
![図: Naive / Advanced / Modular RAGの比較](assets/images/04-naive-advanced-modular-rag.png)
...
![図: RAGの育て方ロードマップ](assets/images/05-rag-roadmap.png)
...
![図: Pre-retrieval Offline Layer詳細図](assets/images/06-pre-retrieval-offline-layer.png)
...
![図: Chunking方式の比較](assets/images/07-chunking-comparison.png)
...
![図: Embeddingとベクトル空間の直感](assets/images/08-embedding-vector-space.png)
...
![図: Retrieval Online Layer詳細図](assets/images/09-retrieval-online-layer.png)
...
![図: クエリ正規化の全体像](assets/images/10-query-normalization-overview.png)
...
![図: Sparse retrievalの直感](assets/images/11-sparse-retrieval-intuition.png)
...
![図: Dense retrievalの直感](assets/images/12-dense-retrieval-intuition.png)
...
![図: Hybrid retrievalとRRF](assets/images/13-hybrid-retrieval-rrf.png)
...
![図: Active retrievalの制御ループ](assets/images/14-active-retrieval-loop.png)
...
![図: Post-retrievalの全体像](assets/images/15-post-retrieval-overview.png)
...
![図: Context packingとLost in the Middle](assets/images/16-context-packing-lost-middle.png)
...
![図: Grounded generationの流れ](assets/images/17-grounded-generation-flow.png)
...
![図: RAG評価の3層構造](assets/images/18-rag-evaluation-three-layers.png)
...
![図: RAG失敗パターンの分類](assets/images/19-rag-failure-patterns.png)
...
![図: RAG評価とストレステストの全体像](assets/images/20-rag-evaluation-stress-tests.png)
...
![図: RAG運用監視ダッシュボード概念図](assets/images/21-rag-monitoring-dashboard.png)
...
![図: RA-LLMの設計空間](assets/images/22-ra-llm-design-space.png)
...
![図: Conversational RAG構成図](assets/images/23-conversational-rag-architecture.png)
...
![図: GraphRAGワークフロー](assets/images/24-graphrag-workflow.png)
...
![図: Agentic RAG詳細構成図](assets/images/25-agentic-rag-architecture.png)

![図: tool useレイヤー構成図](assets/images/26-tool-use-layer.png)
...
![図: Multimodal RAG詳細構成図](assets/images/27-multimodal-rag-architecture.png)
...
![図: Production Baseline RAGアーキテクチャ](assets/images/28-production-baseline-rag.png)
