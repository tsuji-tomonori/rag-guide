...
class Publication:
    ...
    def prose(self, line: str) -> str:
        ...
        if not line.strip() or line.startswith(("#", "![")) or re.match(r"\*\*[図表]\d", line):
            return line
    ...
    def write(self, build_dir: Path) -> None:
        output = [r"\chapter*{参考文献}", r"\markboth{参考文献}{参考文献}", r"\addcontentsline{toc}{chapter}{参考文献}",
